...
use app\tests\codeception\unit\fixtures\ItemTypeFixture;

class ItemTypeTest extends DbTestCase
{
    use Specify;
    ...
    {
        return [
            'type' => ItemTypeFixture::className(),
        ];
    }
    ...
    public function testEdit()
    {
        $this->specify('edit type', function () {
            $type = ItemType::findOne($this->type('edit')->id);
    ...
    public function testPrepareList()
    {
        $this->specify('organize item types into array', function () {
            expect('types list is not empty', (new ItemType())->prepareList())->notEmpty();
        });
    }
    ...
    public function testGetItems()
    {
        $this->specify('test specific type has many items belong to it', function () {
            expect('items list is not empty', ItemType::findOne($this->type('sale')->id)->items)->notEmpty();
        });
    }
}
